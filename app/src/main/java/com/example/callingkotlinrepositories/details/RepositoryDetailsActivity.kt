...
class RepositoryDetailsActivity : BaseActivity<RepositoryDetailsViewModel>() {
    ...
    private fun populateFieldsWithStats(lastYearStats: MutableList<LastYearStats>) {
        ...
        binding.clFirstWeek.tv_week.text = getString(R.string.txt_first_week, convertLongToDate(firstWeekStats.week))
        ...
        binding.clFirstWeek.tv_tuesday.text = getString(R.string.txt_tuesday, firstWeekStats.days[2])
        binding.clFirstWeek.tv_wednesday.text = getString(R.string.txt_wednesday, firstWeekStats.days[3])
        binding.clFirstWeek.tv_thursday.text = getString(R.string.txt_thursday, firstWeekStats.days[4])
        binding.clFirstWeek.tv_friday.text = getString(R.string.txt_friday, firstWeekStats.days[5])
        binding.clFirstWeek.tv_saturday.text = getString(R.string.txt_saturday, firstWeekStats.days[6])

        val lastWeekStats = lastYearStats[51]
        binding.clLastWeek.tv_week.text = getString(R.string.txt_last_week, convertLongToDate(lastWeekStats.week))
        ...
        binding.clLastWeek.tv_wednesday.text = getString(R.string.txt_wednesday, lastWeekStats.days[3])
        binding.clLastWeek.tv_thursday.text = getString(R.string.txt_thursday, lastWeekStats.days[4])
        binding.clLastWeek.tv_friday.text = getString(R.string.txt_friday, lastWeekStats.days[5])
        binding.clLastWeek.tv_saturday.text = getString(R.string.txt_saturday, lastWeekStats.days[6])
    }
